                ...
                <ul className="table-row">
                    ...
                    <li className="table-cell">
                        {/* <div className="flex pages">
                            <div className="blue"><a href="/" style={{textDecoration:'none',color:'#5DABEB'}} onClick={(e)=>{e.preventDefault();}}>上一页&nbsp;</a></div>
                            <div ref="pageshow">1/1</div>
                            <div className="blue"><a href="/" style={{textDecoration:'none',color:'#5DABEB'}} onClick={(e)=>{e.preventDefault();}}>&nbsp;下一页</a></div>
                        </div> */}
                    </li>
